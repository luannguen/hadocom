      ...
      <div className="container mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <span className="text-sm font-semibold text-cyan uppercase tracking-widest">Đối tác</span>
            <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Đối tác & Khách hàng</h2>
            <p className="text-white/60 mt-4 max-w-xl mx-auto">
              Chúng tôi tự hào đồng hành cùng nhiều thương hiệu công nghệ hàng đầu thế giới
            </p>
          </div>
        </ScrollReveal>
