        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a href="/#about" className="text-sm text-white/50 hover:text-cyan transition">{t("nav.about")}</a>
              <a href="/#services" className="text-sm text-white/50 hover:text-cyan transition">{t("nav.services")}</a>
              <Link to="/san-pham" className="text-sm text-white/50 hover:text-cyan transition">{t("nav.products")}</Link>
              <a href="/#contact" className="text-sm text-white/50 hover:text-cyan transition">{t("nav.contact")}</a>
            </div>
          </div>
          <div>
